...
import { props_FileUpload_CNode, type FileUpload_CNode } from "./FileUpload_CNode";
...
export function FileUpload_CNode_UI_Props({ cNode }: I_FileUpload_CNode_UI_Props) {
    ...
    const onChange_fieldKey = useInputOnChange({ cNode, prop: props_FileUpload_CNode.fieldKey });
    const onChange_fieldLabel = useInputOnChange({ cNode, prop: props_FileUpload_CNode.fieldLabel });
    const onChange_fieldPlaceholder = useInputOnChange({ cNode, prop: props_FileUpload_CNode.fieldPlaceholder });
