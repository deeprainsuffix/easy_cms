    ...
    return (
        (
            ...
            >
                {/* 左右上下 */}
                <div
                    className='mpg-border-l-4 mpg-border-solid mpg-border-CNodeSticker-border mpg-absolute'
                    style={{ width: borderWidth, height: height + borderWidth * 2, top: -borderWidth, left: -borderWidth }}
                >
                </div>
                <div
                    className='mpg-border-r-4 mpg-border-solid mpg-border-CNodeSticker-border mpg-absolute'
                    style={{ width: borderWidth, height: height + borderWidth * 2, top: -borderWidth, left: width }}
                >
                </div>
                <div
                    className='mpg-border-t-4 mpg-border-solid mpg-border-CNodeSticker-border mpg-absolute'
                    style={{ width: width + borderWidth * 2, height: borderWidth, top: -borderWidth, left: -borderWidth }}
                >
                </div>
                <div
                    className='mpg-border-b-4 mpg-border-solid mpg-border-CNodeSticker-border mpg-absolute'
                ...
                <div
                    className={`mpg-flex mpg-absolute mpg-bg-CNodeSticker-tool
                       mpg-p-[4px]`}
                    style={{ top: height + borderWidth + 2, right: -(width + borderWidth) }}
                >
