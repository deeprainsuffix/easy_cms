    ...
    return (
        (
            ...
            >
                {/* 左右上下 */}
                <div
                    className='border-solid border-CNodeSticker-border absolute'
                        ...
                        <TooltipProvider>
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <Button onClick={onUpLevel} variant='CNodeSticker-tool' size='CNodeSticker-tool'>
                            ...
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <Button onClick={onDelete} variant='CNodeSticker-tool' size='CNodeSticker-tool' className='mr-0'>
